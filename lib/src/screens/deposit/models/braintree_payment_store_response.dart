...
//
//     final brainTreePaymentStoreResponse = brainTreePaymentStoreResponseFromJson(jsonString);

import 'dart:convert';

class BrainTreePaymentStoreResponse {
  BrainTreePaymentStoreResponse({
    this.success,
    this.message,
    this.data,
  });
  ...
  factory BrainTreePaymentStoreResponse.fromRawJson(String str) =>
      BrainTreePaymentStoreResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory BrainTreePaymentStoreResponse.fromJson(Map<String, dynamic> json) =>
      BrainTreePaymentStoreResponse(
