...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        inherited: json["inherited"] == null
            ? null
            : Inheriteds.fromJson(json["inherited"]),
...
class Inheriteds {
  ...
  factory Inheriteds.fromRawJson(String str) =>
      Inheriteds.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory Inheriteds.fromJson(Map<String, dynamic> json) => Inheriteds(
        firstName: json["first_name"] == null ? null : json["first_name"],
        lastName: json["last_name"] == null ? null : json["last_name"],
        phone: json["phone"] == null ? null : json["phone"],
        address: json["address"] == null ? null : json["address"],
