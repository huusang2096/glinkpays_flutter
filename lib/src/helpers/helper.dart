...
import 'package:vipay/src/models/setting.dart';
import 'package:vipay/src/repository/settings_repository.dart';
...
//        },
  ...
  static List<Icon> getStarsList(double rate) {
    ...
    list = List.generate(rate.floor(), (index) {
      return Icon(Icons.star, size: 12, color: Color(0xFFFFB24D));
    });
    if (rate - rate.floor() > 0) {
      list.add(Icon(Icons.star_half, size: 12, color: Color(0xFFFFB24D)));
    }
    list.addAll(
        List.generate(5 - rate.floor() - (rate - rate.floor()).ceil(), (index) {
      return Icon(Icons.star_border, size: 12, color: Color(0xFFFFB24D));
    }));
    return list;
  }
...
//  }
  ...
  static Html applyHtml(context, String html, {TextStyle style}) {
    ///TODO: handle upgrade html dependency
