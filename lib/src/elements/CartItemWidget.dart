        ...
        onTap: () {
          Navigator.of(context).pushNamed('/Food',
              arguments: RouteArgument(
                  id: widget.cart.food.id.toString(), heroTag: widget.heroTag));
        },
        child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: CachedNetworkImageProvider(
                          (widget.cart?.food?.media?.isEmpty ?? true)
                              ? ''
                              : widget.cart.food.media.first.thumb ?? '',
                        ),
                        fit: BoxFit.cover)),
              ),
              SizedBox(width: 15),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Helper.getPrice(widget.cart.food.price.toDouble(),
